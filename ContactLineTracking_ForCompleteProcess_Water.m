...
folder='D:\Jingdesktop\Durham Project\A1_Water_4000fps_30v';
%%% go into the iamge folder
oldFolder=cd(folder);
% provide your video name (the part before numbers) and format
filetitle='A1_Water_4000fps_30v';
Fileformat ='avi';
...
background_file_end=3743;
drying_start_frame=3; % the frame just before landing (time zero)
drying_end_frame=3743; % end of drying


inverse_frame_start=3730;% The frame where there is a very small inner ring
inverse_frame_end=5;% end frame of your interest
frame_RingForm=2700;% frame around which the spreading stops and swithes to retracting later
...
%      ylabel('y /pixel');
 ...
 Dc_dimentionless=1/R_C(end-2).*R_C; % -2 here to remove the impact of contact of drop on substrate; 
