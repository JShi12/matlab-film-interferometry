...
drying_end_frame=5115; % end of drying
...
BG_Switchfile=2600; % the frame to switch between start background and moving/end background
                    % this frame should be at lease pass the spreading stage 
Bg_gap=30; % the gap between calculationg frame and the background frame ahead 
...
RingWidth2=25; % the approximate ring width
