...
inverse_frame_end=756;%1200;% end frame of your interest/ where the inner film detaches from the ring
skip_frames=0; % take frame+skip_frames+1, no skip: 0

%%% resolutions
resolution=0.40;%um/pixel
frame_rate=2000/(skip_frames+1);%fps 125 for test_01; water case 100fps, 50ethanol/water: \test_image_1: 3000fps. it has to be carefully done as camera could skip save frames
